---
name: brainstorming
description: Use when generating and selecting implementation ideas before planning.
---

# Brainstorming

Use when generating and selecting implementation ideas before planning.
...
- Use this skill when the user asks for brainstorming work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp brainstorm <prompt>`.
