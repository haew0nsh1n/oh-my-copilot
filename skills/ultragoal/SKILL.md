---
name: ultragoal
description: Use when creating durable goal ledgers, checkpoints, artifacts, and implementation evidence.
---

# Ultragoal

Use when creating durable goal ledgers, checkpoints, artifacts, and implementation evidence.
...
- Use this skill when the user asks for ultragoal work or when the current task naturally falls into durable goal execution.
...
- Primary OMP command: `omp ultragoal <task>`.
