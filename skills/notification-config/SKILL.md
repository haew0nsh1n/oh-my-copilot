...
description: Use when preparing and persisting stop callback notification settings.
---

# Notification Config

Use when preparing and persisting stop callback notification settings.
...
- Use this skill when the user asks for notification config work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp config-stop-callback <channel>`.
