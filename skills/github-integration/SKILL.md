...
description: Use when creating GitHub issue, bug report, feature request, or repository domain objects.
---

# GitHub Integration

Use when creating GitHub issue, bug report, feature request, or repository domain objects.
...
- Use this skill when the user asks for github integration work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp github <issue>`.
