---
name: deepinit
description: Use when initializing repository documentation and hierarchical agent context.
---

# Deepinit

Use when initializing repository documentation and hierarchical agent context.
...
- Use this skill when the user asks for deepinit work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp deepinit <input>`.
