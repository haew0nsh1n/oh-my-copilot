---
name: omc-reference
description: Use when consulting OMC-to-OMP compatibility rules, command surfaces, and parity notes.
---

# OMC Reference

Use when consulting OMC-to-OMP compatibility rules, command surfaces, and parity notes.
...
- Use this skill when the user asks for omc reference work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp omc-reference <input>`.
