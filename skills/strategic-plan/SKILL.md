---
name: strategic-plan
description: Use when creating strategic plans with goals, constraints, milestones, and reports.
---

# Strategic Plan

Use when creating strategic plans with goals, constraints, milestones, and reports.
...
- Use this skill when the user asks for strategic plan work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp plan <title> <vision>`.
