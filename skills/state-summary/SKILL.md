---
name: state-summary
description: Use when summarizing persisted .omp runtime state for HUD and diagnostics.
---

# State Summary

Use when summarizing persisted .omp runtime state for HUD and diagnostics.
...
- Use this skill when the user asks for state summary work or when the current task naturally falls into engineering workflow.
