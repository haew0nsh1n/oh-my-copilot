---
name: hooks
description: Use when registering, executing, or reporting lifecycle hook handlers.
---

# Hooks

Use when registering, executing, or reporting lifecycle hook handlers.
...
- Use this skill when the user asks for hooks work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp hooks <event>`.
