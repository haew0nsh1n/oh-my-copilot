---
name: learner
description: Use when extracting reusable learning from a completed workflow.
---

# Learner

Use when extracting reusable learning from a completed workflow.
...
- Use this skill when the user asks for learner work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp learner <input>`.
