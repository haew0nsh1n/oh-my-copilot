---
name: deep-dive
description: Use when tracing a problem into deeper investigation and interview handoff.
---

# Deep Dive

Use when tracing a problem into deeper investigation and interview handoff.
...
- Use this skill when the user asks for deep dive work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp deep-dive <input>`.
