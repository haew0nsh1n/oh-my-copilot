...
description: Use when configuring stop callbacks, notification profiles, or tag lists.
---

# Configure Notifications

Use when configuring stop callbacks, notification profiles, or tag lists.
...
- Use this skill when the user asks for configure notifications work or when the current task naturally falls into notification configuration.
...
- Primary OMP command: `omp configure-notifications`.
