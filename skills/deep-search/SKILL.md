---
name: deepsearch
description: Use when creating codebase search sessions and recording relevant search results.
---

# Deep Search

Use when creating codebase search sessions and recording relevant search results.
...
- Use this skill when the user asks for deepsearch work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp deepsearch <input>`.
