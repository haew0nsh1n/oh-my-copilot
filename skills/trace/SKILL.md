---
name: trace
description: Use when tracing execution history, evidence, or workflow phase transitions.
---

# Trace

Use when tracing execution history, evidence, or workflow phase transitions.
...
- Use this skill when the user asks for trace work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp trace <note>`.
