---
name: deep-interview
description: Use when clarifying requirements, assumptions, goals, and open questions before implementation.
---

# Deep Interview

Use when clarifying requirements, assumptions, goals, and open questions before implementation.
...
- Use this skill when the user asks for deep interview work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp interview <prompt>`.
