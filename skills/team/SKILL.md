...
Use when preparing coordinated provider team workflows and control artifacts.
...
- Use this skill when the user asks for team work or when the current task naturally falls into parallel team coordination.
