...
Use when preparing a team-compatible swarm execution facade.
...
- Use this skill when the user asks for swarm work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp swarm <goal>`.
