...
description: Use when cleaning AI-generated code smells, reviewing slop, or preparing cleanup work for OMP code.
---

# AI Slop Cleaner

Use when cleaning AI-generated code smells, reviewing slop, or preparing cleanup work for OMP code.
...
- Use this skill when the user asks for ai slop cleaner work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp ai-slop-cleaner <input>`.
