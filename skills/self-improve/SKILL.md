---
name: self-improve
description: Use when planning and recording iterative self-improvement of OMP features.
---

# Self Improve

Use when planning and recording iterative self-improvement of OMP features.
...
- Use this skill when the user asks for self improve work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp self-improve <input>`.
