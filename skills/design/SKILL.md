---
name: design
description: Use when recording design sessions, options, decisions, and selected implementation approaches.
---

# Design

Use when recording design sessions, options, decisions, and selected implementation approaches.
...
- Use this skill when the user asks for design work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp design <topic>`.
