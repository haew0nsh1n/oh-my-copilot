...
description: Use when collecting external documentation or reference context before implementation.
---

# External Context

Use when collecting external documentation or reference context before implementation.
...
- Use this skill when the user asks for external context work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp external-context <input>`.
