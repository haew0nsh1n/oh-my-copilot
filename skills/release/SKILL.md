---
name: release
description: Use when preparing release notes, validation evidence, and final packaging checks.
---

# Release

Use when preparing release notes, validation evidence, and final packaging checks.
...
- Use this skill when the user asks for release work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp release <input>`.
