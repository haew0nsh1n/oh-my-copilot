---
name: ccg
description: Use when combining Claude, Codex, Gemini, or alternate provider advisor perspectives.
---

# CCG

Use when combining Claude, Codex, Gemini, or alternate provider advisor perspectives.
...
- Use this skill when the user asks for ccg work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp ccg <input>`.
