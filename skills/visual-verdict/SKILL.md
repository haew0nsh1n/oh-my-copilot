---
name: visual-verdict
description: Use when recording visual QA checks, scores, and pass or fail verdicts.
---

# Visual Verdict

Use when recording visual QA checks, scores, and pass or fail verdicts.
...
- Use this skill when the user asks for visual verdict work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp visual-verdict <target>`.
