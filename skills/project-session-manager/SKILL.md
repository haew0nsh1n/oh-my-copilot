...
description: Use when preparing isolated project session or worktree metadata.
---

# Project Session Manager

Use when preparing isolated project session or worktree metadata.
...
- Use this skill when the user asks for project session manager work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp project-session-manager <input>`.
