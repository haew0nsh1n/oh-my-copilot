...
Use when creating strategic implementation plans, goals, objectives, and milestones.
...
- Use this skill when the user asks for plan work or when the current task naturally falls into engineering workflow.
