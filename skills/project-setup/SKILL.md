---
name: project-setup
description: Use when initializing local .omp state directories for a workspace.
---

# Project Setup

Use when initializing local .omp state directories for a workspace.
...
- Use this skill when the user asks for project setup work or when the current task naturally falls into engineering workflow.
