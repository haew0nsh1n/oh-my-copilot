...
description: Use when hardening high-risk plans with validation rules and stress tests.
---

# Prometheus Strict

Use when hardening high-risk plans with validation rules and stress tests.
...
- Use this skill when the user asks for prometheus strict work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp prometheus <title>`.
