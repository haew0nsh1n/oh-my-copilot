---
name: debug
description: Use when diagnosing bugs, failures, regressions, or unexpected runtime behavior.
---

# Debug

Use when diagnosing bugs, failures, regressions, or unexpected runtime behavior.
...
- Use this skill when the user asks for debug work or when the current task naturally falls into diagnosis.
...
- Primary OMP command: `omp diagnose <failure>`.
