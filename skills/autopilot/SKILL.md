---
name: autopilot
description: Use when running the canonical interview to plan to execute to review to QA workflow as an autonomous OMP mode.
---

# Autopilot

Use when running the canonical interview to plan to execute to review to QA workflow as an autonomous OMP mode.
...
- Use this skill when the user asks for autopilot work or when the current task naturally falls into autonomous workflow coordination.
...
- Primary OMP command: `omp autopilot <task>`.
