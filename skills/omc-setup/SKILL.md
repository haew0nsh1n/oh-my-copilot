...
Use when setting up OMP state through an OMC-compatible setup surface.
...
- Use this skill when the user asks for omc setup work or when the current task naturally falls into engineering workflow.
