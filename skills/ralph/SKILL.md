---
name: ralph
description: Use when running a single-owner persistent completion loop until a task is complete.
---

# Ralph

Use when running a single-owner persistent completion loop until a task is complete.
...
- Use this skill when the user asks for ralph work or when the current task naturally falls into single-owner completion.
...
- Primary OMP command: `omp ralph <task>`.
