---
name: setup
description: Use when initializing local OMP project state and setup artifacts.
---

# Setup

Use when initializing local OMP project state and setup artifacts.
...
- Use this skill when the user asks for setup work or when the current task naturally falls into engineering workflow.
