---
name: ask
description: Use when routing a prompt to an external provider advisor and recording an ask artifact.
---

# Ask

Use when routing a prompt to an external provider advisor and recording an ask artifact.
...
- Use this skill when the user asks for ask work or when the current task naturally falls into provider advice.
