---
name: verify
description: Use when verifying implementation evidence, tests, smoke checks, and completion status.
---

# Verify

Use when verifying implementation evidence, tests, smoke checks, and completion status.
...
- Use this skill when the user asks for verify work or when the current task naturally falls into engineering workflow.
