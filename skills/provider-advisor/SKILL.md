...
description: Use when preparing, checking, executing, or recording provider advisor requests.
---

# Provider Advisor

Use when preparing, checking, executing, or recording provider advisor requests.
...
- Use this skill when the user asks for provider advisor work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp ask <provider> <prompt>`.
