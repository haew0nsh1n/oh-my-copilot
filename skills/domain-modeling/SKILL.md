...
description: Use when defining domain concepts, ubiquitous language, relationships, and validation rules.
---

# Domain Modeling

Use when defining domain concepts, ubiquitous language, relationships, and validation rules.
...
- Use this skill when the user asks for domain modeling work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp domain <project> <description>`.
