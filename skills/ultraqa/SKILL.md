---
name: ultraqa
description: Use when creating QA sessions, test cases, validation results, and merge-readiness reports.
---

# UltraQA

Use when creating QA sessions, test cases, validation results, and merge-readiness reports.
...
- Use this skill when the user asks for ultraqa work or when the current task naturally falls into verification and fix loops.
...
- Primary OMP command: `omp ultraqa <scope>`.
