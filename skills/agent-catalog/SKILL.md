---
name: agent-catalog
description: Use when listing, selecting, or invoking oh-my-copilot specialist agent personas.
---

# Agent Catalog

Use when listing, selecting, or invoking oh-my-copilot specialist agent personas.
...
- Use this skill when the user asks for agent catalog work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp agents`.
