---
name: remember
description: Use when recording durable local project knowledge or reusable workflow notes.
---

# Remember

Use when recording durable local project knowledge or reusable workflow notes.
...
- Use this skill when the user asks for remember work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp wiki <title>`.
