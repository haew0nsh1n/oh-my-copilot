---
name: writer-memory
description: Use when retaining writing or documentation decisions across OMP documentation work.
---

# Writer Memory

Use when retaining writing or documentation decisions across OMP documentation work.
...
- Use this skill when the user asks for writer memory work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp writer-memory <input>`.
