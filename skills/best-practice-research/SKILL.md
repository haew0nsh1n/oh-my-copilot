...
description: Use when collecting official or upstream best-practice evidence before planning implementation.
---

# Best Practice Research

Use when collecting official or upstream best-practice evidence before planning implementation.
...
- Use this skill when the user asks for best practice research work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp best-practice <topic>`.
