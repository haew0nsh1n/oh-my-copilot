---
name: omc-teams
description: Use when preparing OMC-compatible team worker requests and provider team controls.
---

# OMC Teams

Use when preparing OMC-compatible team worker requests and provider team controls.
...
- Use this skill when the user asks for omc teams work or when the current task naturally falls into engineering workflow.
