---
name: cancel
description: Use when cancelling or recording cancellation of an active OMP workflow.
---

# Cancel

Use when cancelling or recording cancellation of an active OMP workflow.
...
- Use this skill when the user asks for cancel work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp cancel <reason>`.
