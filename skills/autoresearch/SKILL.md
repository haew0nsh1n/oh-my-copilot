---
name: autoresearch
description: Use when running bounded research with evidence collection and validation gates.
---

# Autoresearch

Use when running bounded research with evidence collection and validation gates.
...
- Use this skill when the user asks for autoresearch work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp autoresearch <topic>`.
