...
description: Use when managing goal-mode research with professor and critic validation roles.
---

# Autoresearch Goal

Use when managing goal-mode research with professor and critic validation roles.
...
- Use this skill when the user asks for autoresearch goal work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp autoresearch-goal <topic>`.
