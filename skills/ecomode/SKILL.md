...
Use when planning token-efficient routing across model tiers and task complexity.
...
- Use this skill when the user asks for ecomode work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp ecomode <task>`.
