---
name: sparkshell
description: Use when modeling shell command execution, safety validation, and command reports.
---

# Sparkshell

Use when modeling shell command execution, safety validation, and command reports.
...
- Use this skill when the user asks for sparkshell work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp sparkshell <command>`.
