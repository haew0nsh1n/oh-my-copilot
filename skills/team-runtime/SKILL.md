---
name: team-runtime
description: Use when preparing provider-backed teams, readiness checks, and team control artifacts.
---

# Team Runtime

Use when preparing provider-backed teams, readiness checks, and team control artifacts.
...
- Use this skill when the user asks for team runtime work or when the current task naturally falls into parallel team coordination.
...
- Primary OMP command: `omp team <goal>`.
