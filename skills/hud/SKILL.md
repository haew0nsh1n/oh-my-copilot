---
name: hud
description: Use when rendering local OMP state, skill, and agent status summaries.
---

# HUD

Use when rendering local OMP state, skill, and agent status summaries.
...
- Use this skill when the user asks for hud work or when the current task naturally falls into state visibility.
