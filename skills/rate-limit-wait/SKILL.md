...
description: Use when preparing rate-limit wait, auto-resume start, or auto-resume stop state.
---

# Rate Limit Wait

Use when preparing rate-limit wait, auto-resume start, or auto-resume stop state.
...
- Use this skill when the user asks for rate limit wait work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp wait [--start|--stop]`.
