---
name: visual-ralph
description: Use when running visual implementation loops against references and screenshot checks.
---

# Visual Ralph

Use when running visual implementation loops against references and screenshot checks.
...
- Use this skill when the user asks for visual ralph work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp visual-ralph <reference>`.
