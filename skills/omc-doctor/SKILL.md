---
name: omc-doctor
description: Use when running OMC-compatible diagnostics through OMP doctor surfaces.
---

# OMC Doctor

Use when running OMC-compatible diagnostics through OMP doctor surfaces.
...
- Use this skill when the user asks for omc doctor work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp doctor --strict`.
