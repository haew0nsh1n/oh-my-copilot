---
name: sciomc
description: Use when coordinating scientist-style research, evidence gathering, and validation.
---

# SciOMC

Use when coordinating scientist-style research, evidence gathering, and validation.
...
- Use this skill when the user asks for sciomc work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp sciomc <input>`.
