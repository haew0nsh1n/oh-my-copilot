---
name: wiki
description: Use when managing project knowledge pages, indexes, tags, and publication state.
---

# Wiki

Use when managing project knowledge pages, indexes, tags, and publication state.
...
- Use this skill when the user asks for wiki work or when the current task naturally falls into project knowledge.
