...
description: Use when diagnosing failures with evidence, hypotheses, and root-cause reports.
---

# Diagnostics

Use when diagnosing failures with evidence, hypotheses, and root-cause reports.
...
- Use this skill when the user asks for diagnosing bugs work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp diagnosing-bugs <input>`.
