---
name: skillify
description: Use when extracting a reusable workflow as a Markdown skill body.
---

# Skillify

Use when extracting a reusable workflow as a Markdown skill body.
...
- Use this skill when the user asks for skillify work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp skillify <input>`.
