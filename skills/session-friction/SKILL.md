...
description: Use when summarizing sanitized local session friction and context-bloat signals.
---

# Session Friction

Use when summarizing sanitized local session friction and context-bloat signals.
...
- Use this skill when the user asks for session friction work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp session friction report --since <window>`.
