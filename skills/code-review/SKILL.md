---
name: code-review
description: Use when reviewing code quality, standards, findings, and merge readiness.
---

# Code Review

Use when reviewing code quality, standards, findings, and merge readiness.
...
- Use this skill when the user asks for code review work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp review <scope>`.
