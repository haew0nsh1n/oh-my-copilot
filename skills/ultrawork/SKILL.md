---
name: ultrawork
description: Use when planning maximum-parallel execution lanes and aggregating lane results.
---

# Ultrawork

Use when planning maximum-parallel execution lanes and aggregating lane results.
...
- Use this skill when the user asks for ultrawork work or when the current task naturally falls into engineering workflow.
...
- Primary OMP command: `omp ultrawork <goal>`.
