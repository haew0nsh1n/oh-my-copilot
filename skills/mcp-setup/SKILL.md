---
name: mcp-setup
description: Use when preparing MCP integration notes or setup state for OMP-compatible workflows.
---

# MCP Setup

Use when preparing MCP integration notes or setup state for OMP-compatible workflows.
...
- Use this skill when the user asks for mcp setup work or when the current task naturally falls into tooling setup.
...
- Primary OMP command: `omp mcp-setup <input>`.
