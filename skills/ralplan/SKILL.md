---
name: ralplan
description: Use when building architecture plans with architect and critic approval.
---

# RalPlan

Use when building architecture plans with architect and critic approval.
...
- Use this skill when the user asks for ralplan work or when the current task naturally falls into architecture planning and critique.
...
- Primary OMP command: `omp ralplan <title>`.
