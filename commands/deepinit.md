---
description: "Dispatch to the OMP deepinit skill."
---

# OMP Deepinit

Dispatch to the OMP deepinit skill.

## Purpose

Dispatch `deepinit` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/deepinit/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/deepinit/SKILL.md`.
