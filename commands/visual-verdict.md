---
description: "Dispatch to the OMP visual-verdict skill."
---

# OMP Visual Verdict

Dispatch to the OMP visual-verdict skill.

## Purpose

Dispatch `visual-verdict` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/visual-verdict/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/visual-verdict/SKILL.md`.
