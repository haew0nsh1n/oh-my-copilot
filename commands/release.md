---
description: "Dispatch to the OMP release skill."
---

# OMP Release

Dispatch to the OMP release skill.

## Purpose

Dispatch `release` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/release/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/release/SKILL.md`.
