---
description: "Dispatch to the OMP mcp-setup skill."
---

# OMP Mcp Setup

Dispatch to the OMP mcp-setup skill.

## Purpose

Dispatch `mcp-setup` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/mcp-setup/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/mcp-setup/SKILL.md`.
