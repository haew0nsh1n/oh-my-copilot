---
description: "Dispatch to the OMP ccg skill."
---

# OMP Ccg

Dispatch to the OMP ccg skill.

## Purpose

Dispatch `ccg` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/ccg/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/ccg/SKILL.md`.
