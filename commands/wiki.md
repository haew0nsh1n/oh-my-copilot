---
description: "Dispatch to the OMP wiki skill."
---

# OMP Wiki

Dispatch to the OMP wiki skill.

## Purpose

Dispatch `wiki` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/wiki/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/wiki/SKILL.md`.
