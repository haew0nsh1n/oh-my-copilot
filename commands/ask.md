---
description: "Dispatch to the OMP ask skill."
---

# OMP Ask

Dispatch to the OMP ask skill.

## Purpose

Dispatch provider-advisor work without duplicating the long skill instructions.
...
Read `skills/ask/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/ask/SKILL.md`.
