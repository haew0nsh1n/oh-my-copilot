---
description: "Dispatch to the OMP external-context skill."
---

# OMP External Context

Dispatch to the OMP external-context skill.

## Purpose

Dispatch `external-context` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/external-context/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/external-context/SKILL.md`.
