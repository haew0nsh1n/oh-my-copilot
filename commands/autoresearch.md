---
description: "Dispatch to the OMP autoresearch skill."
---

# OMP Autoresearch

Dispatch to the OMP autoresearch skill.

## Purpose

Dispatch bounded research work to the OMP autoresearch skill body.
...
Read `skills/autoresearch/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/autoresearch/SKILL.md`.
