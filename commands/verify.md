---
description: "Dispatch to the OMP verify skill."
---

# OMP Verify

Dispatch to the OMP verify skill.

## Purpose

Dispatch verification work to the OMP verify skill body.
...
Read `skills/verify/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/verify/SKILL.md`.
