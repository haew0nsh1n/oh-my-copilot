---
description: "Dispatch to the OMP omc-teams skill."
---

# OMP OMC TEAMS

Dispatch to the OMP omc-teams skill.

## Purpose

Dispatch `omc-teams` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/omc-teams/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/omc-teams/SKILL.md`.
