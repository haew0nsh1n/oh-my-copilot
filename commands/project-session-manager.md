---
description: "Dispatch to the OMP project-session-manager skill."
---

# OMP Project Session Manager

Dispatch to the OMP project-session-manager skill.

## Purpose

Dispatch `project-session-manager` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/project-session-manager/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/project-session-manager/SKILL.md`.
