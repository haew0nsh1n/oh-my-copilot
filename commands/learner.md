---
description: "Dispatch to the OMP learner skill."
---

# OMP Learner

Dispatch to the OMP learner skill.

## Purpose

Dispatch `learner` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/learner/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/learner/SKILL.md`.
