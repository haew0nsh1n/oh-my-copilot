---
description: "Dispatch to the OMP debug skill."
---

# OMP Debug

Dispatch to the OMP debug skill.

## Purpose

Dispatch failure diagnosis to the OMP debug skill body.
...
Read `skills/debug/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/debug/SKILL.md`.
