---
description: "Dispatch to the OMP remember skill."
---

# OMP Remember

Dispatch to the OMP remember skill.

## Purpose

Dispatch `remember` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/remember/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/remember/SKILL.md`.
