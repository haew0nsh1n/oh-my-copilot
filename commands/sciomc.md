---
description: "Dispatch to the OMP sciomc skill."
---

# OMP Sciomc

Dispatch to the OMP sciomc skill.

## Purpose

Dispatch `sciomc` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/sciomc/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/sciomc/SKILL.md`.
