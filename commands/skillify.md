---
description: "Dispatch to the OMP skillify skill."
---

# OMP Skillify

Dispatch to the OMP skillify skill.

## Purpose

Dispatch `skillify` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/skillify/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/skillify/SKILL.md`.
