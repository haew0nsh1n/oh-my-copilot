---
description: "Dispatch to the OMP skill management skill."
---

# OMP Skill

Dispatch to the OMP skill management skill.

## Purpose

Dispatch `skill` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/skill/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/skill/SKILL.md`.
