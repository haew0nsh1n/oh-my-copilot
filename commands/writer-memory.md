---
description: "Dispatch to the OMP writer-memory skill."
---

# OMP Writer Memory

Dispatch to the OMP writer-memory skill.

## Purpose

Dispatch `writer-memory` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/writer-memory/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/writer-memory/SKILL.md`.
