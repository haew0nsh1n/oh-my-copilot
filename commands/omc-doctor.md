---
description: "Dispatch to the OMP omc-doctor skill."
---

# OMP OMC DOCTOR

Dispatch to the OMP omc-doctor skill.

## Purpose

Dispatch `omc-doctor` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/omc-doctor/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/omc-doctor/SKILL.md`.
