---
description: "Dispatch to the OMP deep-dive skill."
---

# OMP Deep Dive

Dispatch to the OMP deep-dive skill.

## Purpose

Dispatch `deep-dive` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/deep-dive/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/deep-dive/SKILL.md`.
