---
description: "Dispatch to the OMP configure-notifications skill."
---

# OMP Configure Notifications

Dispatch to the OMP configure-notifications skill.

## Purpose

Dispatch `configure-notifications` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/configure-notifications/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/configure-notifications/SKILL.md`.
