---
description: "Dispatch to the OMP hud skill."
---

# OMP Hud

Dispatch to the OMP hud skill.

## Purpose

Dispatch HUD/status work to the OMP HUD skill body.
...
Read `skills/hud/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/hud/SKILL.md`.
