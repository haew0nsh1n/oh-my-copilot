---
description: "Dispatch to the OMP omc-setup skill."
---

# OMP OMC SETUP

Dispatch to the OMP omc-setup skill.

## Purpose

Dispatch `omc-setup` command requests to the matching OMP skill body without embedding long instructions here.
...
Read `skills/omc-setup/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/omc-setup/SKILL.md`.
