---
description: "Dispatch to the OMP trace skill."
---

# OMP Trace

Dispatch to the OMP trace skill.

## Purpose

Dispatch tracing work while preserving runtime context and user arguments.
...
Read `skills/trace/SKILL.md`, follow its workflow, and pass the preserved argument block as the user request.

Target skill body: `skills/trace/SKILL.md`.
